...
public class PhongTro {
    ...
    public void Nhap() {
        System.out.println("Moi nhap so phong: ");
        soPhong = sc.nextInt();
        System.out.println("Moi nhap ten chu phong: ");
        tenChuPhong = new Scanner(System.in).nextLine();
        System.out.println("Moi nhap so dien da dung: ");
        soDienDaDung = sc.nextInt();
        System.out.println("Moi nhap so nuoc da dung: ");
        soNuocDaDung = sc.nextInt();
        System.out.println("Moi tien wifi: ");
        tienWifi = sc.nextInt();
    }
